...
Test Driven Development is a focused, shareable agent workflow.

## What it does

Implement changes through RED-GREEN-REFACTOR with focused regression coverage. Use when a user asks for this workflow or a closely related task.
