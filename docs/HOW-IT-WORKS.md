...
![Step-by-step workflow for Test Driven Development](../assets/workflow.svg)
...
![Safety and approval boundaries for Test Driven Development](../assets/safety-boundary.svg)
