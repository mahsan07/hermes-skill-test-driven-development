...
This repository now includes a typed, task-adaptive harness contract for **Test Driven Development**. The contract maps the skill to memory, planning, capability-orchestration, and action modules; defines bounded repair and stop behavior; and records skill-specific verification evidence.
